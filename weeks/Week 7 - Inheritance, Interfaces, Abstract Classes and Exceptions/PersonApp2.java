...
// Note that abstract classes are not instantiable so no instances of
// Person2 and Student2 can be created.  
// Only GradStudent2 and UGStudent2 instances can be created.  
// However, the superclass types  Person2 and Student2 can be used
// to refer to GradStudent2 and UGStudent2 instances.
// Also, dynamic binding is used to match a method with a method name from
